...
N1=40;M=10; Len=10; times=2; L=4*N1*M;

E0=-0.32;
q=10; EX=linspace(0,5,q);
...
% save data.mat EX Tr1 Tr2 times E0


subplot(1,2,2)
hold on
errorbar(EX,mean(Tr1,2),var(Tr1'),'g');
errorbar(EX,mean(Tr2,2),var(Tr2'),'r');
errorbar(EX,mean(Tr1+Tr2,2),var(Tr1'+Tr2')/2,'b');
